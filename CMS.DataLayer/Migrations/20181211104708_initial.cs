        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonymousUserId = table.Column<int>(nullable: true),
                    SeenDate = table.Column<DateTime>(nullable: true),
                    ResponsText = table.Column<string>(nullable: true),
                    ResponsDate = table.Column<DateTime>(nullable: true),
                    ResponserId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SiteMessages_AnonymousUsers_AnonymousUserId",
                        column: x => x.AnonymousUserId,
                        principalTable: "AnonymousUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SiteMessages_AppUsers_ResponserId",
                        column: x => x.ResponserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SiteMessages_AppUsers_SenderUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteMessages_AnonymousUserId",
                table: "SiteMessages",
                column: "AnonymousUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteMessages_ResponserId",
                table: "SiteMessages",
                column: "ResponserId");
